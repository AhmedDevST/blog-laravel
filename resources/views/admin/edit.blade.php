...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6 tracking-tight">Edit Post</h1>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="6" required
                    class="appearance-none block w-full px-3 py-3 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 dark:bg-gray-900 dark:text-gray-100 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
                    placeholder="Add a brief description">{{ $post->description }}</textarea>
            </div>

            <!-- Creator -->
            <div class="space-y-2">
                <label for="creator" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Creator</label>
                <input type="text" value="{{ $post->user->name }}" disabled id="creator"
                    class="appearance-none block w-full px-3 py-3 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 sm:text-sm">
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="mt-1">
                        <img src="{{ asset('storage/' . $post->image) }}" alt="Current post image"
                            class="h-32 w-auto object-cover rounded-md shadow-sm border border-gray-200 dark:border-gray-700">
                    </div>
                </div>
            @endif
            ...
            <div class="space-y-2">
                ...
                <div class="mt-1 flex items-center">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 ml-3">
